...
export default function Page() {
    ...
    return (
        <main className="flex flex-col py-6">
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-16 mx-5 gap-14 manage text-black'>
                {subscriptions.map((items, i) => (
                    <div className='manageTabs text-center p-10' key={i}>
                        ...
                        <Link href={`/pulsi/${account}`}><button className='text-sm font-bold text-blue bg-transparent hover:bg-blue hover:text-white border-2 border-blue rounded-full py-4 px-12 mb-6'>{items.button}</button></Link>

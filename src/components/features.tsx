...
const workdata: workdata[] = [
    {
        ...
        hiddenpara: 'DataCommas offers a holistic view of your blockchain wallet, encompassing ERC20 tokens, NFTs, and transaction histories. We prioritize user-friendliness, ensuring individuals of all backgrounds can easily access and comprehend their wallet data.',
    },
    {
        ...
        hiddenpara: 'DataCommas equips users with data-driven insights, aiding them in making informed decisions within the blockchain space. Our platform can efficiently handle large datasets, making it a valuable tool for users with significant blockchain activities.',
    },

    ...
    return (
        <div className="simple-bg relative">
            <div className="mx-auto max-w-5xl py-24 px-6">
                ...
                <p className="text-center text-bluish text-lg font-normal mb-8">DataCommas is a transformative web application with a mission to decode complex blockchain data, providing users with comprehensive insights and simplified visualizations. Our platform offers two central features</p>
